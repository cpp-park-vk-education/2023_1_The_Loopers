...
public:
    ...
    virtual void async_write(
            std::string,
            std::function<void(boost::system::error_code, size_t)> = [](boost::system::error_code, size_t) {})
    {
    }

    virtual void async_accept(std::function<void(boost::system::error_code)> = [](boost::system::error_code) {})
    {
    }

    virtual void async_close(std::function<void(boost::system::error_code)> = [](boost::system::error_code) {})
    {
    }
};
