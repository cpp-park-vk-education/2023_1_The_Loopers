...
WebsocketClientSession<DoOnConnectType, DoOnRead, DoOnWrite, DoOnClose>::WebsocketClientSession(
        net::io_context& ioc, const std::string& address, unsigned short port,
        DoOnConnectType doOnConnectType, DoOnRead doOnRead, DoOnWrite doOnWrite,
        DoOnClose doOnClose)
        : m_timer{ioc}, m_doOnConnectType{doOnConnectType}, m_doOnRead{doOnRead},
          m_doOnWrite{doOnWrite}, m_doOnClose{doOnClose}
{
