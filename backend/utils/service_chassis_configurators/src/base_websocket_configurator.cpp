...
std::shared_ptr<ILogger> BaseChassisWebsocketConfigurator::CreateLogger(const std::string& loggerName,
...
void BaseChassisWebsocketConfigurator::AddListener(const std::unique_ptr<IBaseServiceChassis>& chassis,
                                                   io_context& ioContext, std::unique_ptr<ISessionsFactory> factory,
                                                   const Endpoint& endpointSelf)
{
...
void BaseChassisWebsocketConfigurator::AddServiceRegistrator(std::unique_ptr<IBaseServiceChassis>& chassis,
                                                             ServiceType typeSelf, const Endpoint& endpointSelf)
{
...
void BaseChassisWebsocketConfigurator::AddMsgBrokerConnection(
